...
exports.ConventionGet = undefined;
 ...
 */
var ConventionGet = exports.ConventionGet = function (_ConventionBase) {
    _inherits(ConventionGet, _ConventionBase);

    function ConventionGet(entity, meta) {
        _classCallCheck(this, ConventionGet);

        return _possibleConstructorReturn(this, (ConventionGet.__proto__ || Object.getPrototypeOf(ConventionGet)).call(this, entity, meta));
    }

    _createClass(ConventionGet, [{
        key: 'createMethod',
