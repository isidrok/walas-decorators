...
exports.ConventionDelete = undefined;
 ...
 */
var ConventionDelete = exports.ConventionDelete = function (_ConventionBase) {
    _inherits(ConventionDelete, _ConventionBase);

    function ConventionDelete(entity, meta) {
        _classCallCheck(this, ConventionDelete);

        return _possibleConstructorReturn(this, (ConventionDelete.__proto__ || Object.getPrototypeOf(ConventionDelete)).call(this, entity, meta));
    }

    _createClass(ConventionDelete, [{
        key: 'createMethod',
